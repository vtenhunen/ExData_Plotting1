...
# The we should do the fourth plot and print it into the png-file.
...
with(hpc_data, {
      ...
      plot(hpc_data$Time, hpc_data$Sub_metering_1, type="l", ylab = "Energy sub metering", xlab="", col="black")
